      	...
      	<div class="comment-container">
            ...
            <?php } ?>            
	      	...
	      	<div class="comment-head">
                ...
                <span class="date"><?php _e('On', 'woothemes'); ?> <?php echo get_comment_date(get_option( 'date_format' )) ?> <?php _e('at', 'woothemes'); ?> <?php echo get_comment_time(get_option( 'time_format' )); ?></span>
		<span class="name"><?php the_commenter_link() ?></span> <?php _e('responded with...', 'woothemes'); ?>           
